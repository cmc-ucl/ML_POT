...
cat_an_dist, cat_cat_dist, an_an_dist = GULP.DIST_BIN_CALC(wd_path, FIT_path, Train_xyz_path, binwidth, sig2)
GULP.PLOT_DIMER(df_dimer, wd_name, FIT_path, x_axis, cat_an_dist, cat_cat_dist, an_an_dist)
